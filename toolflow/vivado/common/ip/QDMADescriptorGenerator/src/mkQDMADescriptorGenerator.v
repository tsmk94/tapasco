...
//
// On Tue Sep 21 18:18:18 CEST 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkQDMADescriptorGenerator(aclk,
  ...
  wire [63 : 0] v__h8002, y__h15722, y__h16219;
  wire [31 : 0] y__h15679, y__h16196;
  wire [15 : 0] transferLen__h15434, transferLen__h15972;
  ...
  assign MUX_axiCtrlSlave_readSlave_out$enq_1__VAL_3 =
	     { transferLenReg, 2'd0 } ;
  assign MUX_axiCtrlSlave_readSlave_out$enq_1__VAL_4 = { v__h8002, 2'd0 } ;
  assign MUX_c2hCurrReadAddr$write_1__VAL_1 = c2hCurrReadAddr + y__h15722 ;
  assign MUX_c2hCurrWriteAddr$write_1__VAL_1 = c2hCurrWriteAddr + y__h15722 ;
  assign MUX_c2hOutstandingReg$write_1__VAL_1 =
	     c2hOutstandingReg - y__h15679 ;
  assign MUX_h2cCurrReadAddr$write_1__VAL_1 = h2cCurrReadAddr + y__h16219 ;
  assign MUX_h2cCurrWriteAddr$write_1__VAL_1 = h2cCurrWriteAddr + y__h16219 ;
  assign MUX_h2cOutstandingReg$write_1__VAL_1 =
	     h2cOutstandingReg - y__h16196 ;
  ...
  // remaining internal signals
  assign transferLen__h15434 =
	     (c2hOutstandingReg[31:16] == 16'd0) ?
	       c2hOutstandingReg[15:0] :
	       16'h8000 ;
  assign transferLen__h15972 =
	     (h2cOutstandingReg[31:16] == 16'd0) ?
	       h2cOutstandingReg[15:0] :
	       16'h8000 ;
  assign v__h8002 = { 63'd0, dmaResetActive } ;
  assign y__h15679 = { 16'd0, transferLen__h15434 } ;
  assign y__h15722 = { 48'd0, transferLen__h15434 } ;
  assign y__h16196 = { 16'd0, transferLen__h15972 } ;
  assign y__h16219 = { 48'd0, transferLen__h15972 } ;
  ...
  begin
    ...
    if (resetn != `BSV_RESET_VALUE)
	  ...
	  WILL_FIRE_RL_axiCtrlSlave_1_axiWriteSpecial)
	$display("Error: \"/home/torben/Dokumente/Arbeit/QDMADescriptorGenerator/libraries/BlueAXI/src/GenericAxi4LiteSlave.bsv\", line 334, column 18: (R0002)\n  Conflict-free rules RL_axiCtrlSlave_1_axiWriteSpecial_1 and\n  RL_axiCtrlSlave_1_axiWriteSpecial called conflicting methods first and deq\n  of module instance axiCtrlSlave_writeSlave_in.\n");
    if (resetn != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_axiCtrlSlave_1_axiWriteSpecial_1 &&
	  WILL_FIRE_RL_axiCtrlSlave_1_axiWriteSpecial)
