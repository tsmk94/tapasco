...
namespace eval svm {
  proc add_iommu {} {
    if {[tapasco::is_feature_enabled "SVM"]} {
      ...
      set page_dma [tapasco::ip::create_page_dma dma]
      ...
      set mmu [tapasco::ip::create_tapasco_mmu2 mmu_0]
      set mmu_sc [tapasco::ip::create_axi_sc "mmu_sc" 1 1 2]

      connect_bd_net $mem_aclk [get_bd_pins $mmu/S_AXI_aclk]
      connect_bd_net $mem_aresetn [get_bd_pins $mmu/S_AXI_resetn]
      connect_bd_net $pcie_aclk [get_bd_pins $mmu/irq_clk]
      connect_bd_net $pcie_p_aresetn [get_bd_pins $mmu/irq_rst]
      connect_bd_net $mem_aclk [get_bd_pins $mmu_sc/aclk]
